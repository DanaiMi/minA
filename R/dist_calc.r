#' dist_calc – A function for estimating the minimum distance between starting point and species
#'
#' Description
#' An R function that estimates the minimum distance between a specified starting point and the species under study based on the distVincentyEllipsoid function of `geosphere´ package.
#' There is an option to run the function in parallel.
#' `geosphere´, `sp´, `foreach´, `doParallel´ packages should have been installed before using the functions.
#'
#' Usage
